...
public class Followings extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    ArrayList<HashMap<String,String>> followings = new ArrayList<HashMap<String,String>>();
    ...
    public static Followings newInstance(int position, String userrId) {
    ...
    /** for get the following user's **/
    class getfollowings extends AsyncTask<Integer, Void, Void> {

        @Override
        protected Void doInBackground(Integer... params) {
            //final String json = wallafyApplication.loadJSONFromAsset(context, "followers.json");
            int offset= (params[0]*20);
            String SOAP_ACTION = Constants.NAMESPACE + Constants.API_FOLLOWINGS;

            SoapObject req = new SoapObject(Constants.NAMESPACE, Constants.API_FOLLOWINGS);
            ...
            Log.v("followings","followings"+followings);
            return null;
        }
    ...
    private RecyclerView.OnScrollListener onScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrolled(final RecyclerView rv, final int dx, final int dy) {
            ...
            if (!loading && (totalItemCount - visibleItemCount)
                ...
                new getfollowings().execute(currentPage);
                loading = true;
            }
        }
    };
